...
export default async function HalongBayCruisesShoreExcursionsShortPage() {
  let guide = await getGuideBySlug("halong-bay-cruises-shore-excursions-vietnam-tours");
  if (!guide) {
    guide = await getGuideBySlug("halong-bay-cruises-shore-excursions-private-vietnam-tours");
  }
  if (!guide) {
