...
add_action('init', function () {
    ...
    register_post_type('guide', [
        ...
        // 'editor' here is the normal WordPress content editor (Gutenberg/classic) —
        // that's what becomes guide.bodyHtml on the frontend, no extra field needed.
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ['key' => 'field_guide_excerpt', 'name' => 'excerpt', 'label' => 'Excerpt', 'type' => 'textarea', 'rows' => 2,
                'instructions' => 'One or two sentences shown on guide cards and in search results.'],
            ['key' => 'field_guide_region', 'name' => 'region', 'label' => 'Region (optional)', 'type' => 'select',
                'allow_null' => 1,
                'choices' => ['Ha Long Bay' => 'Ha Long Bay', 'Lan Ha Bay' => 'Lan Ha Bay', 'Bai Tu Long Bay' => 'Bai Tu Long Bay']],
